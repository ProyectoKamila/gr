<?php function pk_portada($pk_category){
    ...
    ?>
                        ...
                        ?>
<div class="container-fluid cover"  id="" data-type="parallax" data-speed="20" style="background: url('<?php echo get_field("imagen_de_fondo");?>') top center no-repeat; background-size:cover; background-attachment:fixed;" >
            <div class="row">
